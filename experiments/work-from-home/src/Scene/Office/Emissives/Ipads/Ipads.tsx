...
export function Ipads({ model }: Props) {
  const ref1 = useRef<Mesh<BufferGeometry, IpadMaterialProps>>(null);
  const ref2 = useRef<Mesh<BufferGeometry, IpadMaterialProps>>(null);
  const ref3 = useRef<Mesh<BufferGeometry, IpadMaterialProps>>(null);
  const { nodes } = model;
  ...
  return (
    <>
      <mesh
        ...
        onPointerEnter={() => useExperimentStore.setState({ ipadTopHovered: true })}
        onPointerLeave={() => useExperimentStore.setState({ ipadTopHovered: false })}
      >
      ...
      <mesh
        ...
        onPointerEnter={() => useExperimentStore.setState({ ipadMiddleHovered: true })}
        onPointerLeave={() => useExperimentStore.setState({ ipadMiddleHovered: false })}
      >
      ...
      <mesh
        ...
        onPointerEnter={() => useExperimentStore.setState({ ipadBottomHovered: true })}
        onPointerLeave={() => useExperimentStore.setState({ ipadBottomHovered: false })}
      >
