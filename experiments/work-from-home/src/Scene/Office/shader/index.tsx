...
const BaseOfficeMaterial = shaderMaterial(uniforms, vertexShader, fragmentShader, (m) => {
  if (!m) return;
  m.toneMapped = true;
  m.transparent = true;
});
...
declare module "@react-three/fiber" {
  interface ThreeElements {
    baseOfficeMaterial: MaterialNode<OfficeMaterialProps, typeof BaseOfficeMaterial>;
  }
}
